defmodule Adoptoposs.Submissions.Project do
  ...
  @cast_attrs [:name, :data, :user_id, :language_id, :repo_id, :repo_owner, :repo_description, :description]
  @required_attrs [:name, :data, :user_id, :language_id, :repo_owner, :repo_id, :repo_description, :description]
